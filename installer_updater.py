...
URL_LAUNCHER = "https://github.com/acierto-incomodo/mage_arena/releases/latest/download/launcher_win.exe"
URL_VERSION  = "https://github.com/acierto-incomodo/mage_arena/releases/latest/download/version_win_launcher.txt"
